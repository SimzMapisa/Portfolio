			...
			<div className='relative z-10 py-40 grid grid-cols-12 max-w-6xl mx-auto'>
				<div className='col-span-6'>
					...
					<p className='leading-7'>
						I specialize in designing and developing visually stunning websites
						and apps that deliver seamless functionality and exceptional user
						experiences. From elegant websites to cutting-edge mobile
						applications, my work brings your vision to life, ensuring it not
						only looks good but also works flawlessly. Experience the perfect
						blend of aesthetics and functionality for your digital needs.
					</p>
